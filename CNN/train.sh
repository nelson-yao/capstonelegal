...
# ## ************ Data Security      ***********
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" "Data Security" \
...
# 3-level data
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" 'User Choice/Control' \
...
# ## ************  'Data Retention'  ***********
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" 'Data Retention' \
...
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" 'Do Not Track' \
 "/home/nyao/Embeddings/glove.6B.100d.txt"  --descriptor "CNN_glove" --num-epochs 400 --print-every 200 \
--eval-every 600  --model-name "CNN_glove" --filter-size 3 4 5    \
--dropout-keep-prob 0.8 --save-every 600
...
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" 'First Party Collection/Use' \
...
python cnn_glove_train.py "../Data/sentence_score_conso10_3L_py2.pk" 'User Access, Edit and Deletion' \
