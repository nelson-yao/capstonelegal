...
--eval-every 600  --model-name "CNN_glove_final" --filter-size 3 4 5    \
...
python cnn_glove_train_pred.py "../Data/sentence_score_conso10_3L_py2.pk" 'Policy Change' \
...
python cnn_glove_train_pred.py "../Data/sentence_score_conso10_3L_py2.pk" 'Third Party Sharing/Collection' \
...
python cnn_glove_train_pred.py "../Data/sentence_score_conso10_3L_py2.pk" 'User Access, Edit and Deletion' \
 "/home/nyao/Embeddings/glove.6B.100d.txt"  --descriptor "CNN_glove" --num-epochs 300 --print-every 200 --eval-every 600  --model-name "CNN_glove_final" --filter-size 3 4 5    \
--dropout-keep-prob 0.8 --save-every 600
